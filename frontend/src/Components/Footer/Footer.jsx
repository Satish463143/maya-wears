      ...
      <div className='footer_part'>
        <div className='social_media '>
          <a href="https://www.instagram.com/mayawears.np/" target='_blank'>
            <li>
            <svg height="30px" width="30px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                  viewBox="0 0 56.7 56.7" enableBackground="new 0 0 56.7 56.7" xmlSpace="preserve">
              <g>
                <path d="M28.2,16.7c-7,0-12.8,5.7-12.8,12.8s5.7,12.8,12.8,12.8S41,36.5,41,29.5S35.2,16.7,28.2,16.7z M28.2,37.7
                  c-4.5,0-8.2-3.7-8.2-8.2s3.7-8.2,8.2-8.2s8.2,3.7,8.2,8.2S32.7,37.7,28.2,37.7z"/>
          ...
          <a href="https://www.pinterest.com/mayawears/" target='_blank'>
            <li>
              <svg enableBackground="new 0 0 100 100" height="35px" version="1.1" viewBox="0 0 100 100" width="35px" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"><g id="color_x5F_fill">
