...
const Banner_4List = () => {
    ...
    const getBanner = useCallback(async () => {
      setLoading(true);
      try {
        const response = await collectionSvc.getRequest('/banner_4', {
          auth: true,
        });
  ...
  return (
    <div className='admin_margin_box'>
      <div className="admin_titles">
        <AdminTitle label1=" Banner 4 List" />
                ...
                banner.map((row,index)=>(
                  <tr>
                    ...
                    <td style={{textAlign:'center', width: '150px'}}>
                      <EditButton editUrl={`/admin/banner_4_edit/${row._id}`}/>
                    </td>
                  </tr>
                ))
