...
const Banner_4_Edit = () => {
    ...
    const getDetail = async()=>{
        try{
            const detail = await collectionSvc.getRequest("/banner_4/"+params.id,{auth:true})           
            ...
            navigate("/admin/banner_4") // Navigates after the toast shows 
        }
      }
      ...
      const submitEvent = async (data)=>{
        ...
        try{
            ...
            await collectionSvc.putRequest("/banner_4/" + params.id, submitData, { auth: true, file: true });


            toast.success("Banner Updated Successfully");
            setTimeout(() => navigate("/admin/banner_4"), 1000);
  ...
  return (
    <div className='admin_margin_box'>
        <div className="admin_titles">
            <AdminTitle label1=" Banner 4 List" label2="/Edit_Banner" url="/admin/banner_4"/>
