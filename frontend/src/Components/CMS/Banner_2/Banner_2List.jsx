...
const Banner_2List = () => {
    ...
    const getBanner = useCallback(async () => {
      setLoading(true);
      try {
        const response = await collectionSvc.getRequest('/banner_2', {
          auth: true,
        });
  ...
  return (
    <div className='admin_margin_box'>
      <div className="admin_titles">
        <AdminTitle label1=" Banner 2 List" />
                ...
                banner.map((row,index)=>(
                  <tr>
                    ...
                    <td style={{textAlign:'center', width: '150px'}}>
                      <EditButton editUrl={`/admin/banner_2_edit/${row._id}`}/>
                    </td>
                  </tr>
                ))
