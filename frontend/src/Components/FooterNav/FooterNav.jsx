    ...
    <div className='footnav'>
            ...
            <div className='foornav_box'>
                <ul>
                    ...
                    <Link to="/feed">
                        <li onClick={()=> setNavFoot("Feed")}  className={isnavfoot==="Feed" ? 'nav_foot_active' : ''} >
                            <span>
                                <svg fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
                                    <path clip-rule="evenodd" d="M7 6C7 4.34315 8.34315 3 10 3H18C19.6569 3 21 4.34315 21 6V17.4286C21 19.4438 19.3031 21 17.3077 21H6C4.12382 21 3 19.1526 3 17.4286V9C3 7.34315 4.34314 6 6 6H7ZM9 17.4286C9 17.9599 8.89326 18.5029 8.69065 19H17.3077C18.2861 19 19 18.2537 19 17.4286V6C19 5.44771 18.5523 5 18 5H10C9.44772 5 9 5.44772 9 6V17.4286ZM6 19C6.33296 19 7 18.5449 7 17.4286V8H6C5.44772 8 5 8.44772 5 9V17.4286C5 18.5449 5.66704 19 6 19ZM11 8C11 7.44772 11.4477 7 12 7H16C16.5523 7 17 7.44772 17 8C17 8.55228 16.5523 9 16 9H12C11.4477 9 11 8.55228 11 8ZM11 11C11 10.4477 11.4477 10 12 10H14C14.5523 10 15 10.4477 15 11C15 11.5523 14.5523 12 14 12H12C11.4477 12 11 11.5523 11 11Z" fill="black" fill-rule="evenodd"/>
                                </svg>                                                
                            </span>
                        </li>
                    </Link>
